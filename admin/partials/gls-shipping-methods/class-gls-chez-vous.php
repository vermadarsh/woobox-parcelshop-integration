 ...
 * GLS_Chez_Vous class.
 */
class GLS_Chez_Vous extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-gls-chezvous';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'GLS Chez Vous', 'woopi' );
		$this->method_description = __( 'Colis livré en 24h à 48h.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		...
		$settings = array(
			'title'                            => array(
				...
				'default'     => __( 'GLS Chez Vous', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status'                       => array(
