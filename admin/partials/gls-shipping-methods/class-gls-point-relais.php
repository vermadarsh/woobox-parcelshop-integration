...
/**
 * GLS Point Relais® Shipping Method.
 *
 * @version 1.0.0
...
/**
 * GLS_Point_Relais class.
 */
class GLS_Point_Relais extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-gls-relais';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'GLS Point Relais®', 'woopi' );
		$this->method_description = __( 'Retrait en Point Relais® de votre choix. Vous êtes informé par E-mail ou SMS de l\'arrivé de votre colis.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		...
		$settings = array(
			'title'                            => array(
				...
				'default'     => __( 'GLS Point Relais®', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status'                       => array(
