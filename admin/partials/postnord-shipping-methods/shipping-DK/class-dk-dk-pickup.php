 ...
 * DK_DK_Pickup class.
 */
class DK_DK_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-dk-dk-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'DK DK Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Pickup Denmark.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
