<?php
/**
 * DK DK Commercial Shipping Method.
 *
 * @version 1.0.0
...
/**
 * DK_DK_Commercial class.
 */
class DK_DK_Commercial extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-dk-dk-commercial';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'DK DK Commercial', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Commercial Denmark.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'DK DK Commercial', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
