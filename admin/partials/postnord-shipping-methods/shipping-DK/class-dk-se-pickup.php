 ...
 * DK_SE_Pickup class.
 */
class DK_SE_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-dk-se-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'DK SE Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Denmark Sweden Pickups.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
