 ...
 * DK_FI_Pickup class.
 */
class DK_FI_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-dk-fi-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'DK FI Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Denmark Finland Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
