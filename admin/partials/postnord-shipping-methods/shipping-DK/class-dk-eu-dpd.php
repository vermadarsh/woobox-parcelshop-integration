 ...
 * DK_EU_Dpd class.
 */
class DK_EU_Dpd extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-dk-eu-dpd';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'DK DK Commercial', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - EU Dpd Denmark.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
