<?php
/**
 * DK DK Privatehome Shipping Method.
 *
 * @version 1.0.0
 * @package Woobox Parcelshop Integration/Admin/Partials/Shipping Methods/Shipping DK
 */

defined( 'ABSPATH' ) || exit;

/**
 * DK_DK_Privatehome class.
 */
class DK_DK_Privatehome extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-dk-dk-privatehome';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'DK DK Privatehome', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Privatehome Denmark.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'DK DK Privatehome', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
