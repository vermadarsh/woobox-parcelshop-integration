<?php
/**
 * SE Int. Mailbox Shipping Method.
 *
 * @version 1.0.0
...
/**
 * SE_Int_Mailbox class.
 */
class SE_Int_Mailbox extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-int-mailbox';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE Int. Mailbox', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Int. Mailbox.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'SE Int. Mailbox', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
