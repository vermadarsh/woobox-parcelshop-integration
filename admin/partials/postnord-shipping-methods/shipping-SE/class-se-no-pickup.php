 ...
 * SE_NO_Pickup class.
 */
class SE_NO_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-no-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE NO Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Norway Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
