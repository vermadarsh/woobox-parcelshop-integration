 ...
 * SE_NO_Mailbox class.
 */
class SE_NO_Mailbox extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-no-mailbox';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE NO. Mailbox', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Norway Mailbox.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'SE NO Mailbox', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
