 ...
 * SE_SE_Pickup class.
 */
class SE_SE_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-se-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE SE Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
