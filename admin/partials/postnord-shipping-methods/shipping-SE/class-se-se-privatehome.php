<?php
/**
 * SE SE Privatehome Shipping Method.
 *
 * @version 1.0.0
 * @package Woobox Parcelshop Integration/Admin/Partials/Shipping Methods/Shipping SE
 */

defined( 'ABSPATH' ) || exit;

/**
 * SE_SE_Privatehome class.
 */
class SE_SE_Privatehome extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-se-privatehome';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE SE Privatehome', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Privatehome.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'SE SE Privatehome', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
