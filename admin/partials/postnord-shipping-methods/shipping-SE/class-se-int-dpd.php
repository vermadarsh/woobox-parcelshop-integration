 ...
 * SE_Int_Dpd class.
 */
class SE_Int_Dpd extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		// Parent constructor.
		parent::__construct();
		$this->id                 = 'woopi-pn-se-int-dpd';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE Int. Dpd', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Int. Dpd.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
