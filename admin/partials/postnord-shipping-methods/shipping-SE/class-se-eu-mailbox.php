 ...
 * SE_EU_Mailbox class.
 */
class SE_EU_Mailbox extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		// Parent constructor.
		parent::__construct();
		$this->id                 = 'woopi-pn-se-eu-mailbox';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE EU Mailbox', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden EU Mailbox.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'SE EU Mailbox', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
