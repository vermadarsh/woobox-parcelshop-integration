<?php
/**
 * SE SE Commercial Shipping Method.
 *
 * @version 1.0.0
...
/**
 * SE_SE_Commercial class.
 */
class SE_SE_Commercial extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-se-commercial';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE SE Commercial', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Commercial.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'SE SE Commercial', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
