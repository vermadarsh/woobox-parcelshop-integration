 ...
 * SE_DK_Pickup class.
 */
class SE_DK_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-se-dk-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'SE DK Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Sweden Denmark Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
