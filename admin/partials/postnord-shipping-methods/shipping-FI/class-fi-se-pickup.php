 ...
 * FI_SE_Pickup class.
 */
class FI_SE_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-fi-se-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'FI SE Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Finland Sweden Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
