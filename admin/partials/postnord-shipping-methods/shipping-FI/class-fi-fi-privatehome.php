<?php
/**
 * FI FI Privatehome Shipping Method.
 *
 * @version 1.0.0
 * @package Woobox Parcelshop Integration/Admin/Partials/Shipping Methods/Shipping FI
 */

defined( 'ABSPATH' ) || exit;

/**
 * FI_FI_Privatehome class.
 */
class FI_FI_Privatehome extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-fi-fi-privatehome';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'FI FI Privatehome', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Finland Privatehome.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'FI FI Privatehome', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
