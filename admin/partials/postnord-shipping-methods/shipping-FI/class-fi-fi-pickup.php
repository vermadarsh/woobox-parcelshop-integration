 ...
 * FI_FI_Pickup class.
 */
class FI_FI_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-fi-fi-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'FI FI Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Finland Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
