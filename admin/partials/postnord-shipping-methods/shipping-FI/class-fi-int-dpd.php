 ...
 * FI_Int_Dpd class.
 */
class FI_Int_Dpd extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-fi-int-dpd';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'FI Int Dpd', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Finland Int. Dpd.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
