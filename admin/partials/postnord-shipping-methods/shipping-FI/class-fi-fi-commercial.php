<?php
/**
 * FI FI Commercial Shipping Method.
 *
 * @version 1.0.0
...
/**
 * FI_FI_Commercial class.
 */
class FI_FI_Commercial extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-fi-fi-commercial';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'FI FI Commercial', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Finland Commercial.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'FI FI Commercial', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
