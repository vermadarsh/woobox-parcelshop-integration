 ...
 * FI_EU_Dpd class.
 */
class FI_EU_Dpd extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-fi-eu-dpd';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'FI EU Dpd', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Finland EU Dpd.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
