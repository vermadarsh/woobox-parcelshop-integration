<?php
/**
 * NO NO Privatehome Shipping Method.
 *
 * @version 1.0.0
...
/**
 * NO_NO_Privatehome class.
 */
class NO_NO_Privatehome extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-no-no-privatehome';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO NO Privatehome', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway Privatehome.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'NO NO Privatehome', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
