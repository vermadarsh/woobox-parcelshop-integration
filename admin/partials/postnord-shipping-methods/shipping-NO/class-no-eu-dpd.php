 ...
 * NO_EU_Dpd class.
 */
class NO_EU_Dpd extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-no-eu-dpd';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO EU Dpd', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway EU Dpd.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
