<?php
/**
 * NO Int. Mailbox Shipping Method.
 *
 * @version 1.0.0
...
/**
 * NO_Int_Mailbox class.
 */
class NO_Int_Mailbox extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		// Parent constructor.
		parent::__construct();
		$this->id                 = 'woopi-pn-no-int-mailbox';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO Int. Mailbox', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway Int. Mailbox.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'NO Int. Mailbox', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
