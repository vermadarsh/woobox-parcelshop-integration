 ...
 * NO_DK_Pickup class.
 */
class NO_DK_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-no-dk-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO DK Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway Denmark Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
