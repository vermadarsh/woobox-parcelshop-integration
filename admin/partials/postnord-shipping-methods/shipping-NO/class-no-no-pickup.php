 ...
 * NO_NO_Pickup class.
 */
class NO_NO_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		// Parent constructor.
		parent::__construct();
		$this->id                 = 'woopi-pn-no-no-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO NO Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
