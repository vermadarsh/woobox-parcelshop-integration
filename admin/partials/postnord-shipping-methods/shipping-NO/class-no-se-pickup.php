 ...
 * NO_SE_Pickup class.
 */
class NO_SE_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'woopi-pn-no-se-pickup';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO SE Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway Sweden Pickup.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
