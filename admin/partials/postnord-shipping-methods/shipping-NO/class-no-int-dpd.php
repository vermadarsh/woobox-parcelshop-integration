 ...
 * NO_Int_Dpd class.
 */
class NO_Int_Dpd extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		// Parent constructor.
		parent::__construct();
		$this->id                 = 'woopi-pn-no-int-dpd';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'NO FI Pickup', 'woopi' );
		$this->method_description = __( 'Shipping method dealing - Norway Int. Dpd.', 'woopi' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$settings = array(
			'title'      => array(
				...
				'default'     => __( 'Norway Int. Dpd', 'woopi' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
